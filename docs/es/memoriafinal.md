...
A raíz de este proyecto, nos llevamos un gran conocimiento y una primera toma de contacto con lo que podría ser un entorno de trabajo real, más allá de las prácticas. Nos hemos dado cuenta de que la buena organización y el trabajo en equipo son aspectos fundamentales para el buen desarrollo de cualquier proyecto, y que debemos mejorar de cara al futuro. Además, el tener buena comunicación en todo momento es crucial, para poder llevar a cabo de una manera óptima las tomas de decisiones que como en nuestro caso, por ejemplo, con la eliminación de la tecnología de frontend debido al desconocimiento y problemas que nos estaba dando tuvimos que tomar.

### 12.  CONCLUSIONES, COMENTARIOS Y VALORACIÓN FINAL. <a name="id12"></a>

Creemos que el proyecto junto con las prácticas nos ha brindado una gran experiencia y conocimiento. Nos quedamos con un pequeño mal sabor de boca por no haber sido capaces de sacarle el máximo jugo a la aplicación, al no utilizar un framework de front-end. Como bien comentamos anteriormente, hubo un momento que nos vimos un poco con el agua al cuello y se tomó la decisión de realizar toda la aplicación en Django acompañado de Javascript, Html y Css. En este sentido, creemos que quizá se podría priorizar la enseñanza de un framework de front en el segundo año para reforzar este punto.
